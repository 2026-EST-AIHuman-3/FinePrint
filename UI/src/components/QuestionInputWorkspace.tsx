...
export default function QuestionInputWorkspace({
  ...
  const suggestedHashtags = [
    { label: "환불규정", text: "결제한 지 7일 이내인데 서비스 해지 시 전액 환불받을 수 있나요?" },
    { label: "개인정보 제3자 제공", text: "약관에 내 개인정보나 이용 데이터를 제3자 광고 파트너사에게 마케팅용으로 제공한다는 조항이 있나요?" },
    { label: "해지 위약금", text: "정기 구독 서비스 중도 해지 시 잔여 기간에 대한 위약금이나 수수료가 발생하나요?" }
  ];
