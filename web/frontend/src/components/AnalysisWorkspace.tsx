            ...
            >
              ...
              <div className="bg-surface-white border border-border-muted/70 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col gap-4 relative overflow-hidden">
                <div className="flex justify-between items-start gap-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-[10px] md:text-xs font-bold flex items-center gap-1.5 shrink-0 select-none border ${
                    activeQA.termsEvidence?.length
                      ? "bg-emerald-50 text-emerald-700 border-emerald-200"
                      : "bg-amber-50 text-amber-700 border-amber-200"
                  }`}>
                    <span className={`w-1.5 h-1.5 rounded-full ${activeQA.termsEvidence?.length ? "bg-emerald-500" : "bg-amber-500"}`} />
                ...
                <div className="bg-surface-white border border-border-muted/70 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col gap-3">
                  ...
                  <ul className="space-y-2">
                    {activeQA.checkItems.map((item, index) => (
                      <li key={index} className="text-xs md:text-sm text-on-surface-variant/80 leading-relaxed font-semibold flex gap-2">
